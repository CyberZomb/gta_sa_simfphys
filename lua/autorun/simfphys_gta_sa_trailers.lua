...
local TRAILER = {
    ...
    Model = "models/gta_sa/industrial/artict1.mdl",
    ...
    Members = {
		...
		CustomWheelModel = "models/GTA_SA/industrial/linerun_r_wheel.mdl",
...
local TRAILER = {
    ...
    Model = "models/gta_sa/industrial/artict2.mdl",
    Category = "GTA SA Trailers",
    SpawnOffset = Vector(0,0,40),
    SpawnAngleOffset = 90,
...
local TRAILER = {
    ...
    Model = "models/gta_sa/industrial/artict2a.mdl",
    Category = "GTA SA Trailers",
    SpawnOffset = Vector(0,0,40),
    SpawnAngleOffset = 90,
...
local TRAILER = {
    ...
    Model = "models/gta_sa/industrial/artict3.mdl",
    Category = "GTA SA Trailers",
    SpawnOffset = Vector(0,0,40),
    SpawnAngleOffset = 90,
...
local TRAILER = {
    Name = "Tanker Trailer",
    Model = "models/GTA_SA/industrial/petrotr.mdl",
    Category = "GTA SA Trailers",
