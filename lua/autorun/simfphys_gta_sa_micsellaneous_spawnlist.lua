local V = {
	...
	Model = "models/GTA_SA/miscellaneous/bloodra.mdl",
	...
	Members = {
		...
		CustomWheelModel = "models/GTA_SA/miscellaneous/bloodra_wheel.mdl",
...
local V = {
	...
	Model = "models/GTA_SA/miscellaneous/bloodrb.mdl",
	Class = "gmod_sent_vehicle_fphysics_base",
	Category = "GTA SA Miscellaneous",
	SpawnOffset = Vector(0,0,20),
	SpawnAngleOffset = 90,
	...
	Members = {
		...
		CustomWheelModel = "models/GTA_SA/miscellaneous/bloodrb_wheel.mdl",
		CustomWheelPosFL = Vector(64.5,32.9,-12.6),
		CustomWheelPosFR = Vector(64.5,-32.9,-12.6),
		CustomWheelPosRL = Vector(-64.2,32.9,-12.6),
		CustomWheelPosRR = Vector(-64.2,-32.9,-12.6),
...
local V = {
	Name = "Hotring Racer",
	Model = "models/GTA_SA/miscellaneous/hotring.mdl",
	Class = "gmod_sent_vehicle_fphysics_base",
	Category = "GTA SA Miscellaneous",
	...
	Members = {
		...
		CustomWheelModel = "models/GTA_SA/miscellaneous/hotring_wheel.mdl",
...
local V = {
	...
	Model = "models/GTA_SA/miscellaneous/hotrina.mdl",
	Class = "gmod_sent_vehicle_fphysics_base",
	Category = "GTA SA Miscellaneous",
	SpawnOffset = Vector(0,0,30),
	SpawnAngleOffset = 90,
...
local V = {
	...
	Model = "models/GTA_SA/miscellaneous/hotrinb.mdl",
	Class = "gmod_sent_vehicle_fphysics_base",
	Category = "GTA SA Miscellaneous",
	SpawnOffset = Vector(0,0,30),
	SpawnAngleOffset = 90,
